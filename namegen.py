...
#Germ
germ_XY=['Alex', 'Lukas', 'Michael', 'Daniel', 'Philipp', 'Jonas', 'Fabian', 'Marcel', 'Tim', 'Kevin', 'Jan', 'David', 'Tom', 'Markus', 'Sebastian', 'Julian', 'Leon', 'Christoph', 'Simon', 'Felix', 'Andreas', 'Nils', 'Nico', 'Martin', 'Max', 'Florian', 'Dennis', 'Patrick', 'Thomas', 'Christopher', 'Moritz', 'Nick', 'Chris', 'Paul', 'Jonathan', 'Tobias', 'Jakob', 'Christian', 'Adrian', 'Matthias', 'Dominik', 'Stefan', 'René', 'Ali', 'Marco', 'Vincent', 'Mohamed', 'Kai', 'Erik', 'Ludwig', 'Hendrik', 'Mario', 'Oliver', 'Lucas', 'Anton', 'Timo', 'Sven', 'Marc', 'Andre', 'Gabriel', 'Leo', 'Arthur', 'Maximilian', 'Ben', 'Jannik', 'Niklas', 'Noah', 'Peter', 'Mark', 'Johannes', 'Konrad', 'Alexander', 'Pierre', 'Jason', 'Frank', 'Marvin', 'Till', 'Artur', 'Luca', 'Fabio', 'Lasse', 'Jens', 'Konstantin', 'Tamino', 'William', 'Luis', 'Alihan', 'Ricardo', 'Victor', 'Jeremy', 'Brian', 'Dustin', 'Janis,Niels', 'Jesse', 'Phil', 'Yoda', 'Muhammed', 'Bako', 'Gerrit']

germ_XX=['Lea', 'Julia', 'Laura', 'Anna', 'Lisa', 'Lena', 'Sarah', 'Katharina', 'johanna', 'Sophie', 'Marie', 'Leonie', 'Vanessa', 'Alina', 'Lara', 'Jana', 'Hannah', 'Jessica', 'Annika', 'Luisa', 'Michelle', 'melanie', 'Jasmin', 'Sabrina', 'Linda', 'Sandra', 'Anja', 'Christina', 'Nina', 'Nadine', 'Maria', 'Anne', 'Carina', 'Pia', 'Nicole', 'Céline', 'Eva', 'Sophia', 'Jenny', 'Jennifer', 'Steffi', 'Janine', 'Franzi', 'Franziska', 'Carolin', 'Marina', 'Elena', 'Antonia', 'Kim', 'Elisa', 'Nele', 'Melissa', 'Natascha', 'Svenja', 'Nadja', 'Rebecca', 'Larissa', 'Emma', 'Sara', 'Katja', 'Stella', 'Sina', 'Natalie', 'Lina', 'Andrea', 'Kathrin', 'Mia', 'Theresa', 'Alexandra', 'Pauline', 'Denise', 'Julie', 'Charlotte', 'Elli', 'Kira', 'Janina', 'Paula', 'Mona', 'Stefanie', 'Louisa', 'Ella', 'Merle', 'Verena', 'Ina', 'Emily', 'Fiona', 'Anni', 'Clara', 'Alice', 'Elisabeth', 'Jacqueline', 'Tamara', 'Kathi', 'Jule', 'Amelie', 'Hanna', 'Mara', 'Melina', 'Isabel', 'Fabienne']

germ_apellidos=['Müller', 'Schmidt', 'Schneider', 'Fischer', 'Weber', 'Schäfer', 'Meyer', 'Wagner', 'Becker', 'Bauer', 'Hoffmann', 'Schulz', 'Koch', 'Richter', 'Klein', 'Wolf', 'Schröder', 'Neumann', 'Braun', 'Werner', 'Schwarz', 'Hofmann', 'Zimmermann', 'Schmitt', 'Hartmann', 'Schmid', 'Weiß', 'Schmitz', 'Krüger', 'Lange', 'Meier', 'Walter', 'Köhler', 'Maier', 'Beck', 'König', 'Krause', 'Schulze', 'Huber', 'Mayer', 'Frank', 'Lehmann', 'Kaiser', 'Fuchs', 'Herrmann', 'Lang', 'Thomas', 'Peters', 'Stein', 'Jung', 'Möller', 'Berger', 'Martin', 'Friedrich', 'Scholz', 'Keller', 'Groß', 'Hahn', 'Roth', 'Günther', 'Vogel', 'Schubert', 'Winkler', 'Schuster', 'Lorenz', 'Ludwig', 'Baumann', 'Heinrich', 'Otto', 'Simon', 'Graf', 'Kraus', 'Krämer', 'Böhm', 'Schulte', 'Albrecht', 'Franke', 'Winter', 'Schumacher', 'Vogt', 'Haas', 'Sommer', 'Schreiber', 'Engel', 'Ziegler', 'Dietrich', 'Brandt', 'Seidel', 'Kuhn', 'Busch', 'Horn', 'Arnold', 'Kühn', 'Bergmann', 'Pohl', 'Pfeiffer', 'Wolff', 'Voigt', 'Sauer']

#Ital
ital_XY= ['Andrea', 'Marco', 'Francesco', 'Luca', 'Matteo', 'Alessandro', 'Davide', 'Federico', 'Lorenzo', 'Stefano', 'Giuseppe', 'Riccardo', 'Daniele', 'Simone', 'Gabriele', 'Antonio', 'Mattia', 'Christian', 'Alberto', 'Fabio', 'Emanuele', 'Giovanni', 'Roberto', 'Filippo', 'Michele', 'Edoardo', 'Nicola', 'Alex', 'Giorgio', 'Alessio', 'Claudio', 'Raffaele', 'Giacomo', 'Leonardo', 'Domenico', 'Nicolò', 'Salvatore', 'Gianluca', 'Vincenzo', 'Luigi', 'Mario', 'Carlo', 'Pietro', 'Michael', 'Cristian', 'Samuele', 'Giulio', 'Mauro', 'Nicholas', 'Tommaso', 'Paolo', 'Ivan', 'Leo', 'Mirko', 'Vito', 'Dario', 'Manuel', 'Enrico', 'Thomas', 'Kevin', 'Cyril', 'Angelo', 'Jacopo', 'Daniel', 'Vittorio', 'Piero', 'Elia', 'Rosario', 'Carmine', 'Samuel', 'Guido', 'Fabrizio', 'Flavio', 'Diego', 'Gianmarco', 'Gabriel', 'Max', 'Emiliano', 'Ale', 'Simon', 'Maurizio', 'Elias', 'Tiziano', 'Valerio', 'Mike', 'Pier', 'Damiano', 'Massimo', 'Mark', 'Patrick', 'Cristiano', 'Enzo', 'Saverio', 'Tom', 'Luciano', 'Denis', 'Umberto', 'Sergio', 'Martin', 'John']

ital_XX= ['Giulia', 'Chiara', 'Sara', 'Martina', 'Francesca', 'Silvia', 'Elisa', 'Alice', 'Federica', 'Alessia', 'Laura', 'Elena', 'Giorgia', 'valentina', 'eleonora', 'Anna', 'Marta', 'claudia', 'ilaria', 'sofia', 'Arianna', 'Beatrice', 'Irene', 'Roberta', 'Michela', 'Gaia', 'Alessandra', 'Valeria', 'Giada', 'Simona', 'aurora', 'Cristina', 'Veronica', 'Maria', 'Rebecca', 'Serena', 'Noemi', 'Benedetta', 'Ludovica', 'paola', 'Lisa', 'Greta', 'camilla', 'Elisabetta', 'Miriam', 'Caterina', 'lucrezia', 'Letizia', 'Margherita', 'Jessica', 'Carlotta', 'Annalisa', 'Daniela', 'Lucia', 'barbara', 'Linda', 'Ginevra', 'Cecilia', 'Giovanna', 'Mary', 'Angela', 'Sabrina', 'Gloria', 'Vanessa', 'Monica', 'Sarah', 'Emma', 'Matilde', 'Viola', 'Diana', 'Nicole', 'Rachele', 'Marika', 'Emanuela', 'Stefania', 'Erika', 'Debora', 'Gabriella', 'Antonella', 'Angelica', 'Rosa', 'Luisa', 'Giusy', 'Teresa', 'ilenia', 'Isabella', 'Bianca', 'Adele', 'manuela', 'Julia', 'Samantha', 'Marina', 'Sonia', 'Marzia', 'Melissa', 'Nadia', 'Erica', 'Gioia', 'Anita', 'Eva']

ital_apellido=['Abruzzo', 'Accardi', 'Agosti', 'Alfonsi', 'Albertelli', 'Allegra', 'Amato', 'Argento', 'Armani', 'Bambino', 'Barilla', 'Barbieri', 'Barone', 'Bellucci', 'Bernardi', 'Berlusconi', 'Bertelli', 'Bianchi', 'Bianco', 'Borghese', 'Brambilla', 'Bruni', 'Bruno', 'Caputo', 'Carbone', 'Carozza', 'Caruso', 'Cattaneo', 'Colombo', 'Conte', 'Coppola', 'Costa', 'D’Angelo', 'De', 'Luca', 'De', 'Santis', 'DeVille', 'Di', 'Fazio', 'Donato', 'Esposito', 'Fabbri', 'Farina', 'Favero', 'Ferrante', 'Ferrari', 'Ferrucci', 'Fiore', 'Fontana', 'Galilei', 'Gallo', 'Gatti', 'Gentile', 'Gianni', 'Giordano', 'Grasso', 'Greco', 'Guerra', 'Guerriero', 'Guiluliani', 'Lamberti', 'Leone', 'Lioni', 'Lombardi', 'Longo', 'Magnifico', 'Mancini', 'Marchetti', 'Mariano', 'Marino', 'Martini', 'Mazza', 'Messina', 'Monti', 'Morelli', 'Moretti', 'Negri', 'Nicastro', 'Nicoli', 'Orsini', 'Palumbo', 'Parisi', 'Pellegrini', 'Puddu', 'Puma', 'Quattro', 'Rabito', 'Raffa', 'Ranallo', 'Ricci', 'Romano', 'Rossi', 'Russo', 'Sala', 'Sanna', 'Santoro', 'Sartori', 'Scotti', 'Segreto', 'Silvestri', 'Sorrento', 'Tedesco', 'Uberti', 'Villa', 'Vitale', 'Valentino', 'Venturi', 'Verga', 'Vinci', 'Zappa', 'Zunino']
